...
const REQUETE_ADVANCER = `SELECT numeroCompte, num, compte.email as email,identification, photoPDP, attribut, mdp, statu, unite, u_cin, nom, prenom FROM compte, individu WHERE compte.u_cin = individu.cin `;
