...
import AddLivrable from "./components/statistiques/addLivrable";
import AddPhase from "./components/procedures/addPhase";
    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="nouveauLivrable/"
            element={<SinInProtected Cmp={AddLivrable} />}
          />
          <Route
            path="nouveauPhase/"
            element={<SinInProtected Cmp={AddPhase} />}
          />
        </Routes>
      </BrowserRouter>
    </div>
