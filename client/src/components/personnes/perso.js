            ...
            <div className="card-body ">
              <div className="row">
                ...
                <div className="col-7 d-flex align-items-center">
                  <div className="numbers">
                    <p className="card-category">liste</p>
                    <h4 className="card-title">Organismes</h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body ">
              <div className="row">
                ...
                <div className="col-7 d-flex align-items-center">
                  <div className="numbers">
                    <p className="card-category">Nouveau</p>
                    <h4 className="card-title">Organisme</h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body ">
              <div className="row">
                ...
                <div className="col-7 d-flex align-items-center">
                  <div className="numbers">
                    <p className="card-category">Nouveau</p>
                    <h4 className="card-title">Livrable</h4>
                  </div>
                </div>
              </div>
            </div>
...
export function NouveauPhase() {
  return (
    <>
      <div className="col-md-4">
        <div className="card card-stats card-primary">
          <Link to="/nouveauPhase">
            <div className="card-body ">
              <div className="row">
                <div className="col-5">
                  <div className="icon-big text-center">
                ...
                <div className="col-7 d-flex align-items-center">
                  <div className="numbers">
                    <p className="card-category">Nouveau</p>
                    <h4 className="card-title">Phase</h4>
                  </div>
                </div>
              </div>
            </div>
