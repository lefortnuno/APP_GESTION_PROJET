...
import { organismes } from "../../../api/data_array.js";
...
export default function Individu() {
  ...
  const currentItems = organismes.slice(indexOfFirstItem, indexOfLastItem);
                          ...
                          <tbody>
                            {contenuTab || users.length !== 0 ? (
                              currentItems.map((user, key) => (
                                <tr key={key}>
                                  <th scope="row">{user.CodeOrganisme} </th>
                                  <td>{user.NomOrganisme}</td>
                                  <td>{user.AdresseOrganisme}</td>
                                  <td>{user.TelephoneOrganisme}</td>
                                  <td>{user.NomContact}</td>
                                  <td>{user.EmailContact}</td>
                                  <td>{user.AdresseWeb}</td>
